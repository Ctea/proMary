        ...
        .state('home', {
            ...
            controller: function($scope, $http, $timeout) {
                ...
                $scope.previousPage = function() {
                    ...
                    let element = angular.element(document.querySelector('.animate-slide'));
                    element
                        .finish()
                        .css({
                            opacity: 1,
                ...
                $scope.nextPage = function() {
                    if($scope.pageSize * ($scope.currentPage + 1) >= $scope.productList().length)
                        return;
                    $scope.isAnimate = true;
                    let element = angular.element(document.querySelector('.animate-slide'));
                    element
...
.filter('pagination', function() {
    return function(items, scope) {
        ...
        let end = (scope.currentPage + 1) * scope.pageSize;
...
.controller('MainController', function($scope, $http, $location, $uibModal) {
    ...
    $scope.openProductModal = function (size, product) {
